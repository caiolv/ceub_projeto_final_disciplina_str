...
function turn_around_time(processos) {
    ...
    let tat = Array.from({length: processos.length}, (_, i) => 0);
...
#############################################
*/
var wt = waiting_time(processos)
var tat = turn_around_time(processos)
var avg_wt = average_wt(processos)
var avg_tat = average_tat(processos)
